...
namespace MegaMini
{
    internal class CachedCryptoTransform(Func<ICryptoTransform> factory, bool isKnownReusable) : ICryptoTransform
    {
        private readonly Func<ICryptoTransform> _factory = factory;
        private readonly bool _isKnownReusable = isKnownReusable;
